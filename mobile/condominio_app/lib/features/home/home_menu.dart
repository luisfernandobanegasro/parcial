...
class HomeMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Mantén el tamaño de texto estable para que no rompa el grid
            ...
            children: [
              ...
              Expanded(
                child: GridView.count(
                  ...
                  mainAxisSpacing: 12,
                  crossAxisSpacing: 12,
                  childAspectRatio: 1.2, // <-- Ajusta si quieres más alto/bajo
                  children: [
                    FeatureTile(
